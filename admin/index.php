      ...
      <div class="content">
		...
		<a>
           ...
           <div class="col-md-12">
            <div class="card ">
              <div class="card-header card-header-primary">
               <center> <h4 class="card-title"> Users List</h4> </center>
              </div>
              <div class="card-body">
           ...
           <div class="col-md-4">
            <div class="card ">
              <div class="card-header card-header-primary">
         <center><h4 class="card-title">Subscribers</h4> <center>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <center><h4 class="card-title"> Categories List</h4></center>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
          ...
          <div class="col-md-4">
            <div class="card ">
              <div class="card-header card-header-primary">
                <center><h4 class="card-title">Brands List</h4></center>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                        $result=mysqli_query($con1,"select * from brands")or die ("query 1 incorrect.....");
                        $i=1;
                        while(list($brand_id,$brand_title)=mysqli_fetch_array($result))
                        {	
